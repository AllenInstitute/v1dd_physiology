...
nwb_path = r"\\allen\programs\mindscope\workgroups\surround" \
           r"\v1dd_in_vivo_new_segmentation\data\nwbs\M409828_1a_20190104.nwb"

save_folder = r'\\allen\programs\mindscope\workgroups\surround' \
              r'\v1dd_in_vivo_new_segmentation\data\response_tables'
trace_type = 'dff'
time_win = [-0.5, 1.5]
...
save_path = os.path.join(save_folder, f'response_table_{nwb_fn[0:10]}.hdf5')
