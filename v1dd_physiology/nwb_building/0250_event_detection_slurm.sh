...
#SBATCH -o /allen/programs/mindscope/workgroups/surround/jun_testing/slurm_output/v1dd_event_%A_%a.out
#SBATCH -e /allen/programs/mindscope/workgroups/surround/jun_testing/slurm_output/v1dd_event_%A_%a.err
...
script_path="/allen/programs/mindscope/workgroups/surround/v1dd_in_vivo_new_segmentation/v1dd_physiology/v1dd_physiology/nwb_building/0240_event_detection_slurm.py"
